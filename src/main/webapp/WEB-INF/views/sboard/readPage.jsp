        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" id="boardDeleteBtn" class="btn btn-danger removeBtn">REMOVE</button>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <label for="exampleInputEmail1">Writer</label> <input class="form-control" type="text" placeholder="USER ID" id="newReplyWriter"> 
...
$(document).ready(function(){
    ...
    // 댓글 수정(modify) 이벤트 처리 Modal 팝업창 띄움
